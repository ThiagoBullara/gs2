            ...
            <div class="row rowVideo">
                <div class="col100">
                    <div class="titleTextVideo">
                        ...
                        <p>Caso esteja com problemas para visualizar o vídeo por favor acesse o link: <a class="redlink" href="https://www.youtube.com/watch?v=gVk5H-bNKkA">Link vídeo</a></p>
                    </div>
                    <div class="videoBx">
                    <iframe width="100%" height="585" src="https://www.youtube.com/embed/gVk5H-bNKkA" title="Musicoterapia - Music for Health" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>                    </div>
                </div>
            </div>
        </section>
